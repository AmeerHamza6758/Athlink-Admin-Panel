...
const Login = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-row">
      <div
        className={`h-full w-[50%] xl:w-[50%] flex items-center justify-center`}
        style={{
      ...
      <div className="h-full w-[50%] xl:w-[50%] flex items-center justify-center">
        <div className="w-full xl:w-[80%]  px-12">
          ...
          <div className=" py-8 w-full mx-auto">
            ...
            <p className="text-base text-[#808D9E]">
            ...
            <button
              className="w-full py-3 mt-6  bg-primary rounded-xl text-lg font-semibold text-white"
